...
<div class="container-fluid p-0" id="main-content">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admission.form') }}">Admission Form</a>
                        </li>
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow-lg border-0 rounded-lg admission-tracker animate__animated animate__fadeInDown">
                <div class="card-header header-background text-white text-center py-4">
                        <h2 class="animate__animated animate__fadeIn">Track Your Admission Application</h2>
                    </div>
                    <div class="card-body p-4 bg-light">
                        ...
                        <form action="{{ route('admission.tracker') }}" method="POST">
                            @csrf
                            ...
                            <button type="submit" class="btn btn-secondary btn-block mt-4">Track Application</button>
                        </form>
                    </div>
                </div>
            </div>
