            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header border-bottom">
                        <div class="row g-3">
                            <div class="col-md-2 user_department"></div>
                            <div class="col-md-2 user_year_level"></div>
                            <div class="col-md-2 user_section"></div>
                            <div class="col-md-2 user_school_year"></div>
                            <div class="col-md-2 user_semester"></div>
                            <div class="col-md-2 user_gender"></div>
                        </div>
                    </div> <br>
                                    ...
                                    @foreach($students as $student)
                                        ...
                                        <span class="text-truncate d-flex align-items-center">
                                            <span class="badge badge-center me-2">
                                                <div class="btn btn-sm @if(strtolower($student->Gender) === 'male') bg-primary-subtle @else bg-danger-subtle @endif rounded-circle">
...
<!-- DataTable Initialization and AJAX Filtering Script -->
<script>
    ...
    this.api().columns().every(function (colIdx) {
        ...
        if (columnClassMapping[colIdx]) {
            ...
            const select = $('<select class="form-select"><option value="">Select ' + column.header().innerHTML + '</option>')
